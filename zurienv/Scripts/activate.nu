...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\ADMIN\Desktop\14G\Django Project\zurienv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\ADMIN\Desktop\14G\Django Project\zurienv\Scripts\deactivate.nu'
